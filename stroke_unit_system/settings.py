"""
Django settings for stroke_unit_system project.
...
SECRET_KEY = 'django-insecure-@a0-i9$j(bcb#j96_44w5qk2ynm(%p^&k-^2sw@e_drxmdg)zx'
...
ROOT_URLCONF = 'stroke_unit_system.urls'
...
WSGI_APPLICATION = 'stroke_unit_system.wsgi.application'
